...
**Gaps #1–#36 first slices cleared** (mobile store API upload still deferred).  
...
1. ~~Bands #24–#36~~ — Local intent through Pulse cut-hint expand.  
...
|---|------|-------------------------|
| ~~24–36~~ | ~~Local intent … Pulse cut hints expand~~ | ~~done~~ |
