...
**Gaps #1–#41 first slices cleared** (mobile store API upload still deferred).  
...
1. ~~Bands #24–#41~~ — Local intent through Launch commerce parity.  
...
|---|------|-------------------------|
| ~~24–41~~ | ~~Local intent … Launch commerce parity~~ | ~~done~~ |
