...
**Gaps #1–#39 first slices cleared** (mobile store API upload still deferred).  
...
1. ~~Bands #24–#39~~ — Local intent through Guide notes expand.  
...
|---|------|-------------------------|
| ~~24–39~~ | ~~Local intent … Guide notes expand~~ | ~~done~~ |
