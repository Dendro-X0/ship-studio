...
**Gaps #1–#42 first slices cleared** (mobile store API upload still deferred).  
...
1. ~~Bands #24–#42~~ — Local intent through Heroku/Amplify hosts.  
...
|---|------|-------------------------|
| ~~24–42~~ | ~~Local intent … Heroku/Amplify hosts~~ | ~~done~~ |
