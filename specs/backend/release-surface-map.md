...
**Gaps #1–#40 first slices cleared** (mobile store API upload still deferred).  
...
1. ~~Bands #24–#40~~ — Local intent through Commerce portal catalog.  
...
|---|------|-------------------------|
| ~~24–40~~ | ~~Local intent … Commerce portal catalog~~ | ~~done~~ |
