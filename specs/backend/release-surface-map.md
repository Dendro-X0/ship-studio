...
**Gaps #1–#44 first slices cleared** (mobile store API upload still deferred).  
...
1. ~~Bands #24–#44~~ — Local intent through Launch marketplace submit parity.  
...
|---|------|-------------------------|
| ~~24–44~~ | ~~Local intent … Launch marketplace submit~~ | ~~done~~ |
