...
**Gaps #1–#33 first slices cleared** (mobile store API upload still deferred).  
...
1. ~~Bands #24–#33~~ — Local intent through TUI publish watch.  
...
|---|------|-------------------------|
| ~~24–33~~ | ~~Local intent … TUI watch~~ | ~~done~~ |
