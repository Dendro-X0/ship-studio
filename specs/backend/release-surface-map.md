...
**Gaps #1–#34 first slices cleared** (mobile store API upload still deferred).  
...
1. ~~Bands #24–#34~~ — Local intent through MCP publish watch.  
...
|---|------|-------------------------|
| ~~24–34~~ | ~~Local intent … MCP watch~~ | ~~done~~ |
