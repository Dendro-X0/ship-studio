...
**Gaps #1–#43 first slices cleared** (mobile store API upload still deferred).  
...
1. ~~Bands #24–#43~~ — Local intent through Launch host/BaaS parity.  
...
|---|------|-------------------------|
| ~~24–43~~ | ~~Local intent … Launch host/BaaS parity~~ | ~~done~~ |
