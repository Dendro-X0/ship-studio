...
| S0.3 | **Public download path** | **Next after S0.4/S0.5** — GitHub Release + SHA256 |
| S0.4 | **Paid delta on `/pricing`** | **In progress (release week)** |
| S0.5 | **Brand disambiguation** | **In progress (release week)** |
