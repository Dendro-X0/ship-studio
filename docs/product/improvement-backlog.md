...
| S1.2k | **Desktop reliability (TTY · toasts)** | Env Put terminal · unified opener · soft-fail taxonomy — [design](../../specs/backend/desktop-reliability-design.md) · **slice 1 shipped**; slice 2 next |
