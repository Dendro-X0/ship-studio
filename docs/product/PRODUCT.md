...
**Overhaul roadmap:** **Done O0–O5** — [ship-studio-overhaul-design](../../specs/backend/ship-studio-overhaul-design.md) · [human-gate-catalog-design](../../specs/backend/human-gate-catalog-design.md) · [mcp-assist-contract-design](../../specs/backend/mcp-assist-contract-design.md) · [Harbor evidence](../handoffs/evidence-harbor-client-honesty.md)
