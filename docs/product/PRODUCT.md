...
GOAL:     Local shipping hub — Client for humans, MCP for agents, CLI as kernel;
          final-mile sign → release → deploy; human gates per overhaul O1–O5
